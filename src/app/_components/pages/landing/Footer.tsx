    ...
    <div className="mb-[100px]">
      ...
      <div className="flex px-16 sm:!pl-[56px] sm:!pr-[40px] max-w-[1360px] mx-auto mt-[40px] gap-[16px] justify-between flex-wrap flex-col-reverse md:!flex-nowrap md:!flex-row">
        ...
        <div className="flex items-center justify-center gap-[9px]">
          ...
          <a href={settingsData.github} target="_blank" rel="noopener noreferrer">
            <div
              className={`flex w-[44px] h-[44px] items-center justify-center ${
                isDarkMode
                  ? "bg-[rgba(47,47,47)]"
          ...
          <a href={settingsData.instagram} target="_blank" rel="noopener noreferrer">
            <div
              className={`flex w-[44px] h-[44px] items-center justify-center ${
                isDarkMode
                  ? "bg-[rgba(47,47,47)]"
          ...
          <a href={settingsData.linkedin} target="_blank" rel="noopener noreferrer">
            <div
              className={`flex w-[44px] h-[44px] items-center justify-center ${
                isDarkMode
                  ? "bg-[rgba(47,47,47)]"
